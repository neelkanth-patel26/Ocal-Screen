					...
					<form onSubmit={handleSubmit} className="space-y-4">
						...
						<div className="space-y-2">
							...
							{attachEnv && sysDetails && (showSpecDetails || true) && (
								...
								>
									<div
										className="flex items-center justify-between font-sans font-extrabold text-xs mb-1.5"
									...
									<div className="truncate">
										<strong className="font-sans text-slate-500">OS:</strong> {sysDetails.os}
									</div>
									<div className="truncate">
										<strong className="font-sans text-slate-500">CPU:</strong> {sysDetails.cpu}
									</div>
									<div className="truncate">
										<strong className="font-sans text-slate-500">RAM:</strong> {sysDetails.ram}
									</div>
									<div className="truncate">
										<strong className="font-sans text-slate-500">GPU:</strong> {sysDetails.gpu}
									</div>
								</div>
							)}
						</div>
