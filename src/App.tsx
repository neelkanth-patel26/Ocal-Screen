...
import { OcalLoader } from "./components/ui/ocal-loader";
			...
			case "editor":
				return (
					<ShortcutsProvider>
						<Suspense
							fallback={
								<div className="flex flex-col items-center justify-center gap-3 h-screen bg-[#0c0c0c]">
									<OcalLoader size="lg" text={tEditor("loadingEditor")} />
								</div>
							}
						>
							<VideoEditor />
